...
namespace TwigaCRM.Pages.Products
{
    ...
    public class EditModel : PageModel
    {
        ...
        {
            IsPermitted = _checkPermissions.CheckPermission(User, "edit_product");
            if (!IsPermitted)
            {
            ...
            Product = await _context.Product
                .Include(p => p.BusinessLine).FirstOrDefaultAsync(m => m.Id == id);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                ...
                _toastNotification.Success("Product Edited!");
            }
