...
{
    [Authorize]
    public class DemoReportsModel : PageModel
    {
        ...
        public DemoReportsModel(TwigaCRM.Data.ApplicationDbContext context, UserManager<AppUser> userManager, INotyfService toastNotification, CheckPermissionsService checkPermissions)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!ModelState.IsValid)
            {
                ...
                return RedirectToPage("./DemoReports");
            }
