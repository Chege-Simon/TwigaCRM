...
{
    [Authorize]
    public class RAMCollectionMonthlyPerformanceReportModel : PageModel
    {
        ...
        public RAMCollectionMonthlyPerformanceReportModel(TwigaCRM.Data.ApplicationDbContext context, UserManager<AppUser> userManager, INotyfService toastNotification, CheckPermissionsService checkPermissions)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnGetAsync(int FinancialYearId, int Month, string RAMId)
        {
            ...
            RAMDailyCollections = await _context.RAMDailyCollection
                    ...
                    .Where(d => d.RAMDailyCollectionReport.RAMId == RAMId && d.RAMDailyCollectionReport.SalesDate.Month == Month && (d.RAMDailyCollectionReport.SalesDate.Year == financialYear.StartDate.Year || d.RAMDailyCollectionReport.SalesDate.Year == financialYear.EndDate.Year) && d.RAMDailyCollectionReport.ApprovalStatus == "Approved").ToListAsync();
