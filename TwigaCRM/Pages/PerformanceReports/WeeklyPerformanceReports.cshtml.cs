...
{
    [Authorize]
    public class WeeklyPerformanceReportModel : PageModel
    {
        ...
        public WeeklyPerformanceReportModel(TwigaCRM.Data.ApplicationDbContext context, UserManager<AppUser> userManager, INotyfService toastNotification, CheckPermissionsService checkPermissions)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnGetAsync(int FinancialYearId, int Month, string SalesPersonId)
        {
            ...
            DailyMovements = await _context.DailyMovement
                    ...
                    .Where(d => d.DailyMovementReport.SalesPersonId == SalesPersonId && d.DailyMovementReport.SalesDate.Month == Month && (d.DailyMovementReport.SalesDate.Date >= financialYear.StartDate.Date && d.DailyMovementReport.SalesDate.Date <= financialYear.EndDate.Date) && d.DailyMovementReport.TLstatus == "Approved")
            ...
            Targets = await _context.Target
                    ...
                    .Where(d => d.SalesMovement.SalesPersonId == SalesPersonId && d.SalesMovement.Month == Month && d.SalesMovement.FinancialYearId == financialYear.Id && d.SalesMovement.TLstatus == "Approved")
                    .OrderByDescending(s => s.Id).ToListAsync();
