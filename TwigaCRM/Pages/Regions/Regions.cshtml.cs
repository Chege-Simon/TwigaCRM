...
namespace TwigaCRM.Pages.Regions
{
    ...
    public class IndexModel : PageModel
    {
        ...
        {
            IsPermitted = _checkPermissions.CheckPermission(User, "view_regions");
            if (!IsPermitted)
            {
        ...
        {
            IsPermitted = _checkPermissions.CheckPermission(User, "assign_town");
            if (!IsPermitted)
            {
                return RedirectToPage("/403");
            }
            ...
            _toastNotification.Success("Region Created!");
