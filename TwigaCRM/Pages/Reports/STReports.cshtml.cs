...
{
    [Authorize]
    public class STReportsModel : PageModel
    {
        ...
        public STReportsModel(TwigaCRM.Data.ApplicationDbContext context, UserManager<AppUser> userManager, INotyfService toastNotification, CheckPermissionsService checkPermissions)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!ModelState.IsValid)
            {
                ...
                return RedirectToPage("./STReports");
            }


            return RedirectToPage("./MonthlySTReport", new { month = Input.Month, financialYearId = Input.FinancialYearId});
        }
    }
}
