...
namespace TwigaCRM.Pages.Permissions
{
    ...
    public class EditModel : PageModel
    {
        ...
        {
            IsPermitted = _checkPermissions.CheckPermission(User, "edit_permission");
            if (!IsPermitted)
            {
            ...
            var permission =  await _context.Permission.FirstOrDefaultAsync(m => m.Id == id);
            if (permission == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                ...
                _toastNotification.Success("Permissions Edited!");
            }
