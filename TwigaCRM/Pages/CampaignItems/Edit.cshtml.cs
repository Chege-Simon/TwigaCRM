...
namespace TwigaCRM.Pages.CampaignItems
{
    ...
    public class EditModel : PageModel
    {
        ...
        {
            IsPermitted = _checkPermissions.CheckPermission(User, "edit_campaign_item");
            if (!IsPermitted)
            {
            ...
            CampaignItem = await _context.CampaignItem.FirstOrDefaultAsync(m => m.Id == id);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!ModelState.IsValid)
            {
                ...
                return RedirectToPage("./Edit", new {id = CampaignItem.Id});
            }

            _context.Attach(CampaignItem).State = EntityState.Modified;

            try
            {
                //await _context.SaveChangesAsync();
                await _context.SaveChangesAsync(User?.FindFirst(ClaimTypes.NameIdentifier).Value);
                _toastNotification.Success("Campaign Item Edited!");
            }
        ...
        {
            return _context.CampaignItem.Any(e => e.Id == id);
        }
    }
}
