...
{
    [Authorize]
    public class DCReportsModel : PageModel
    {
        ...
        public DCReportsModel(TwigaCRM.Data.ApplicationDbContext context, UserManager<AppUser> userManager, INotyfService toastNotification, CheckPermissionsService checkPermissions)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            IsPermitted = _checkPermissions.CheckPermission(User, "generate_daily_collection_report");
            if (!IsPermitted)
            {
