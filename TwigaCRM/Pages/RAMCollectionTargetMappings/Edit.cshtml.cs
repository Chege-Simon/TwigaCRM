    ...
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int? id)
        {
            ...
            RAMCollectionTargetMapping = await _context.RAMCollectionTargetMapping
                ...
                .Include(r => r.RAMCollectionTarget).FirstOrDefaultAsync(m => m.Id == id);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!ModelState.IsValid)
            {
                ...
                return RedirectToPage("../RAMCollectionTargets/Details", new { id = RAMCollectionTargetMapping.RAMCollectionTargetId });
            }
            ...
            _context.Attach(RAMCollectionTargetMapping).State = EntityState.Modified;
            ...
            {
                if (!RAMCollectionTargetMappingExists(RAMCollectionTargetMapping.Id))
                {
                    return NotFound();
                }
                else
        ...
        private bool RAMCollectionTargetMappingExists(int id)
        {
            return _context.RAMCollectionTargetMapping.Any(e => e.Id == id);
        }
    }
}
